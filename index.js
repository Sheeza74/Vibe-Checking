...
const questions = [
    {
        text:"🌅 It's Saturday morning. What are doing?" ,
        choices:[{label:"Still in bed. Obviously." , points: 0} ,
                 ...
                 {label:"Reorganizing my bookshelf" ,points: 3}]
    },

    {
        text:"📱 Your Phone battery hits 10%. You..." ,
        choices:[{label:"Panic immediately." , points: 0},
    ...
    {
        text:"🍕 You prdered pizza but got the wrong one. You..." ,
        choices:[{label:"Eat it anyway. Food is food." , points: 0},
...

    {
        ...
        choices:[{label:"Complete silence." , points: 0},
                 {label:"Lo-fi beats." , points: 1},
                 {label:"Full movie soundtracks." , points: 2},
                 {label:"Chaos .Anytime loud." , points: 3}]
    },

    {
        text:"🌈 Pick a vibe for your ideal weekend trip:" ,
        choices:[{label:"cozy cabin in the mountains." , points: 0},
...
function computeVibe(totalScore) {
    if(totalScore <= 3)
        return {
          ...
          desc: "Comfort is your superpower. You know exactly what you like and you protect your peace."
    };
      ...
      return {
        ...
        desc: "Your thoughts move faster than your words. You're always three steps ahead. Maybe slow down? No?"
    }
